  ...
  <div class="col-md-12">
    <div class="tile shadow-sm border-0">
      ...
      <div class="tile-body">
        ...
        <form method="GET" action="{{ route('chef-master.reports') }}" id="shiftSelectForm" class="mb-3">
...
<div class="receipt-report-container">
    ...
    <div class="signature-grid">
        <div class="signature-box">
            ...
            <strong>{{ isset($selectedShift) && $selectedShift ? ($selectedShift->staff->name ?? 'CHEF MASTER') : 'CHEF MASTER' }}</strong>
