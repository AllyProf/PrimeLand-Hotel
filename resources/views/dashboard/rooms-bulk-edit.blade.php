              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="price_per_night" name="update_fields[price_per_night]" step="0.01" min="0" placeholder="Leave empty to keep current">
                  </div>
                  <small class="form-text text-muted">Update price for all selected rooms</small>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="extra_guest_fee">Extra Guest Fee (USD)</label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text">$</span>
                    </div>
                    <input class="form-control" type="number" id="extra_guest_fee" name="update_fields[extra_guest_fee]" step="0.01" min="0" placeholder="Leave empty to keep current">
                  </div>
                </div>
              </div>
            </div>
