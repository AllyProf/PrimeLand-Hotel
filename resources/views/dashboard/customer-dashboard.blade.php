  ...
  <div class="col-md-12">
    <div class="tile" style="padding: 0;">
      <div class="tile-body" style="padding: 0;">
        ...
        <div style="background: linear-gradient(135deg, #e77a3a 0%, #d66a2a 100%); color: white; padding: 20px; border-radius: 4px 4px 0 0;">
          <div class="d-flex align-items-center justify-content-between flex-wrap">
            <div class="flex-grow-1" style="min-width: 0;">
              <h2 style="color: #18e7e5; margin: 0 0 10px 0; font-weight: 700; font-size: 24px;" class="welcome-title">
                Welcome to Prime Land Hotel, {{ $firstName }}!
              </h2>
        ...
        <div class="row" style="margin: 0;">
          ...
          <div class="{{ ($weather && is_array($weather) && !isset($weather['error'])) ? 'col-md-6 col-12' : 'col-md-12 col-12' }}" style="padding: 0;">
            @if(count($upcomingCheckOuts ?? []) > 0)
              ...
              @endphp
              <div class="alert alert-warning alert-dismissible fade show mb-0" role="alert" style="border-left: 4px solid {{ $isCorporate ? '#e77a3a' : '#ffc107' }}; border-radius: 0; margin: 0; padding: 15px 20px;">
                <div class="d-flex align-items-start flex-wrap">
                  <i class="fa {{ $isCorporate ? 'fa-building' : 'fa-calendar-times-o' }} fa-lg mr-2" style="color: {{ $isCorporate ? '#e77a3a' : '#ffc107' }}; flex-shrink: 0;"></i>
                  <div class="flex-grow-1" style="min-width: 0;">
                    <h6 class="alert-heading mb-1" style="font-size: 14px; margin: 0;">
                      ...
                      @if($isCorporate)
                        <span class="badge badge-warning ml-2" style="background-color: #e77a3a; color: white; font-size: 10px;">Company</span>
                      @endif
          ...
          <div class="col-md-12" style="padding: 0;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center;">
              ...
              <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 16px;">
                We hope you had a wonderful experience at PrimeLand Hotel. Your feedback helps us improve our services.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row" style="margin: 0;">
          <div class="col-md-12" style="padding: 0;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center;">
              ...
              <h3 style="color: white; margin: 0 0 10px 0; font-weight: 600;">Welcome to PrimeLand Hotel!</h3>
              <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 16px;">
...
<div class="row mb-3">
  <div class="col-md-12">
    ...
    @php
      ...
      $paymentResponsibility = $booking->payment_responsibility ?? 'company';
    @endphp
    <div class="alert alert-info alert-dismissible fade show mb-2" role="alert" style="border-left: 4px solid {{ $isCorporate ? '#e77a3a' : '#17a2b8' }}; padding: 12px 15px;">
      <div class="d-flex align-items-center flex-wrap">
        <i class="fa {{ $isCorporate ? 'fa-building' : 'fa-calendar-check-o' }} fa-lg mr-2" style="color: {{ $isCorporate ? '#e77a3a' : '#17a2b8' }};"></i>
  ...
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-title-w-btn">
        <h3 class="tile-title"><i class="fa fa-map-marker"></i> Directions to PrimeLand Hotel</h3>
        <div class="btn-group">
            ...
            <div id="dashboardRouteInfo" style="padding: 15px;">
              ...
              <div id="dashboardRouteDetails" style="display: none;">
                ...
                <div style="padding: 10px; background: #e7f3ff; border-left: 3px solid #17a2b8; border-radius: 5px;">
                  <small>
                    <strong><i class="fa fa-map-marker"></i> PrimeLand Hotel</strong><br>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background: #17a2b8; color: white;">
        <h5 class="modal-title"><i class="fa fa-map-marker"></i> Directions to PrimeLand Hotel</h5>
              ...
              <div id="routeInfo" style="display: none; margin-bottom: 15px;">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    <a href="https://www.google.com/maps/dir/?api=1&destination=PrimeLand+Hotel,Sokoine+Road,Moshi,Kilimanjaro,Tanzania&key={{ config('services.google.maps_api_key') }}" 
                       target="_blank" 
    ...
    <div class="tile">
      <div class="tile-title-w-btn">
        <h3 class="tile-title">
          ...
          @if($isCorporate)
            <span class="badge badge-warning ml-2" style="background-color: #e77a3a; color: white; font-size: 11px;">Company Booking</span>
          @endif
        </h3>
        <div class="btn-group">
      ...
      <div class="tile-body">
        @if($isCorporate && $company)
        <div class="alert alert-info mb-3" style="background-color: #e7f3ff; border-left: 3px solid #e77a3a;">
          <div class="d-flex align-items-center">
            <i class="fa fa-building fa-lg mr-2" style="color: #e77a3a;"></i>
            <div>
    ...
    <div class="tile">
      ...
      <div class="tile-body">
        @php
          ...
          $companyRoomChargesUSD = 0;
          $companyRoomChargesTZS = 0;
          $companyServiceChargesUSD = 0;
          $companyServiceChargesTZS = 0;
          $selfServiceChargesUSD = 0;
          ...
          foreach($activeBookings as $booking) {
            ...
            if ($booking->check_in_status === 'checked_out') {
              ...
              if ($isCorporate) {
                  ...
                  $companyRoomChargesUSD += $extensionCostUSD;
                  ...
                  if ($paymentResponsibility == 'self') {
                      ...
                      $guestServicesUSD = $serviceRequests->sum('total_price_tsh') / $bookingExchangeRate;
                      $selfServiceChargesUSD += $guestServicesUSD;
                      $selfServiceChargesTZS += $serviceRequests->sum('total_price_tsh');
                      $billUSD = $guestServicesUSD;
                      
                      // Calculate paid services
                      $paidTZS = $serviceRequests->where('payment_status', 'paid')->sum('total_price_tsh');
                      $paidUSD = $paidTZS / $bookingExchangeRate;
                  } else {
                      // Company pays for everything
                      $allServicesUSD = $serviceRequests->sum('total_price_tsh') / $bookingExchangeRate;
                      $companyServiceChargesUSD += $allServicesUSD;
                  ...
                  $otherServiceChargesUSD = $serviceRequests->sum('total_price_tsh') / $bookingExchangeRate;
                  $billUSD = $extensionCostUsd + $otherServiceChargesUSD;
                  $paidAdditionalChargesUSD = ($booking->amount_paid ?? $booking->total_price) - $booking->total_price;
                  $paidUSD = max(0, $paidAdditionalChargesUSD);
              }
            } else {
              // For active bookings
              // Note: When staff extends a booking, total_price already includes the extension cost
              $extensionCostUsd = 0;
              // Only calculate extension cost if it's a pending extension request (not yet applied to total_price)
              ...
              $roomPriceUSD = $booking->total_price; // Already includes extension if approved
              $extensionCostUSD = $extensionCostUsd; // Only for pending extensions
              
              if ($isCorporate) {
                // Room charges are always paid by company
                $companyRoomChargesUSD += $roomPriceUSD + $extensionCostUSD;
                $companyRoomChargesTZS += ($roomPriceUSD + $extensionCostUSD) * $bookingExchangeRate;
                ...
                if ($paymentResponsibility == 'self') {
                  ...
                  // Guest's payment is for their services (exclude room_charge status as that's unpaid)
                  $paidTZS = $serviceRequests->where('payment_status', 'paid')->sum('total_price_tsh');
                  $paidUSD = $paidTZS / $bookingExchangeRate;
                } else {
                  // Company pays for everything
                ...
                $totalServiceChargesUSD = $serviceRequests->sum('total_price_tsh') / $bookingExchangeRate;
                $billUSD = $roomPriceUSD + $extensionCostUSD + $totalServiceChargesUSD;
                
                // Amount paid in USD
                if ($booking->payment_status === 'paid' && !$booking->amount_paid) {
                  $paidUSD = $roomPriceUSD;
                } else {
            ...
            // Convert to TZS for TZS display using the locked rate
            $billTZS = $billUSD * $bookingExchangeRate;
            $paidTZS = $paidUSD * $bookingExchangeRate;
            
            $bookingOutstandingUSD = $billUSD - $paidUSD;
            if ($bookingOutstandingUSD > 0 && !$bookingWithOutstanding) {
              $bookingWithOutstanding = $booking;
            }
            
            $totalBillUSD += $billUSD;
        ...
        <div class="alert alert-info mb-3" style="background-color: #e7f3ff; border-left: 4px solid #e77a3a;">
          <h6 style="color: #e77a3a; margin-bottom: 10px;"><i class="fa fa-building"></i> Company Booking Payment Breakdown</h6>
          <div style="font-size: 12px;">
            <div class="mb-2">
              ...
              @else
                <span class="text-muted">(${{ number_format($companyRoomChargesUSD, 2) }} ≈ {{ number_format($companyRoomChargesTZS, 2) }} TZS)</span>
              @endif
            </div>
            @php
            ...
            <div class="mb-2">
              ...
              @if($selfServiceChargesTZS > 0)
                ...
                @else
                  <span class="text-muted">(${{ number_format($selfServiceChargesUSD, 2) }} ≈ {{ number_format($selfServiceChargesTZS, 2) }} TZS)</span>
                @endif
              @else
                <span class="text-muted">($0.00 - No services used yet)</span>
              @endif
            </div>
            @endif
            ...
            <div class="mb-2">
              ...
              @if($companyServiceChargesTZS > 0)
                ...
                @else
                  <span class="text-muted">(${{ number_format($companyServiceChargesUSD, 2) }} ≈ {{ number_format($companyServiceChargesTZS, 2) }} TZS)</span>
                @endif
              @else
                <span class="text-muted">($0.00 - No services used yet)</span>
              @endif
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <p class="mb-0 mt-1" style="color: #555;">
                ...
                @else
                  <strong>${{ number_format($outstandingUSD, 2) }}</strong> (≈ {{ number_format($outstandingTZS, 2) }} TZS).
                @endif
              </p>
            </div>
          </div>
              ...
              <div class="col-6">
                ...
                @php
                  ...
                  if ($isCorporateMobile) {
                    ...
                    $totalServiceChargesUSDMobile = ($otherServiceChargesTshMobile + $transportationChargesTshMobile) / $bookingRate;
                    
                    if ($paymentResponsibilityMobile == 'self') {
                      $guestBillUSDMobile = $totalServiceChargesUSDMobile;
                      $guestBillTZSMobile = ($otherServiceChargesTshMobile + $transportationChargesTshMobile);
                    } else {
                      $guestBillUSDMobile = 0;
                ...
                @endphp
                @if($isCorporateMobile)
                  @if($paymentResponsibilityMobile == 'self' && $bookingPriceUSD > 0)
                    @if($isBookingTanzanian)
                      <strong>{{ number_format($bookingPriceTZS, 2) }} TZS</strong>
                      <br><small class="text-muted">(Services only)</small>
                    @else
                      <strong>${{ number_format($bookingPriceUSD, 2) }}</strong><br>
                      <small style="color: #e07632;">≈ {{ number_format($bookingPriceTZS, 2) }} TZS</small>
                      <br><small class="text-muted">(Services only)</small>
                    @endif
                  @else
                ...
                @if($isExtended && $booking->room && $extendedNights > 0)
                  ...
                  <br><small class="text-muted" style="font-size: 10px;">Original: ${{ number_format($originalPrice, 2) }}</small>
            ...
            <tbody>
              ...
              <tr class="booking-row" data-booking-id="{{ $booking->id }}" style="cursor: pointer;">
                <td>
                  ...
                  @if($isCorporate)
                    <span class="badge badge-warning ml-1" style="background-color: #e77a3a; color: white; font-size: 9px;">Company</span>
                  @endif
                  <br><small class="text-muted">Guest ID: {{ $booking->guest_id ?? 'N/A' }}</small>
                  @if($isCorporate && $company)
                ...
                <td>
                  @php
                    ...
                    if ($isCorporate) {
                      ...
                      $totalServiceChargesUSD = ($otherServiceChargesTsh + $transportationChargesTsh) / $bookingRate;
                      
                      if ($paymentResponsibility == 'self') {
                        $guestBillUSD = $totalServiceChargesUSD;
              ...
              <div class="service-card-mobile mb-2" style="background: white; border: 1px solid #ddd; border-radius: 6px; padding: 12px;">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <small style="color: #28a745;">≈ ${{ number_format($serviceRequest->unit_price_tsh / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}</small>
                  </div>
                </div>
                <div class="mt-2 pt-2" style="border-top: 1px solid #eee;">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                      ...
                      <small style="color: #28a745;">≈ ${{ number_format($serviceRequest->total_price_tsh / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="service-total-mobile mt-3 pt-3" style="border-top: 2px solid #e07632;">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="text-right">
                    ...
                    <small style="color: #28a745;">≈ ${{ number_format(($booking->total_service_charges_tsh ?? 0) / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}</small>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div style="color: #28a745; font-size: 11px;">
                        ≈ ${{ number_format($serviceRequest->unit_price_tsh / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}
                      </div>
                    </td>
                    <td>
                      <div><strong>{{ number_format($serviceRequest->total_price_tsh, 2) }} TZS</strong></div>
                      <div style="color: #28a745; font-size: 11px;">
                        <strong>≈ ${{ number_format($serviceRequest->total_price_tsh / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}</strong>
                      </div>
                    </td>
                    <td>
                      @if($serviceRequest->status === 'pending')
                ...
                <tfoot>
                  <tr>
                    ...
                    <td colspan="2">
                      ...
                      <div style="color: #28a745; font-size: 11px;">
                        <strong>≈ ${{ number_format(($booking->total_service_charges_tsh ?? 0) / ($booking->locked_exchange_rate ?? $exchangeRate ?? 2500), 2) }}</strong>
                      </div>
                    </td>
                  </tr>
                </tfoot>
...
function initializeDirectionsMap() {
  // Hotel location (PrimeLand Hotel, Sokoine Road, Moshi, Tanzania)
  ...
  const hotelInfoWindow = new google.maps.InfoWindow({
    content: `
      <div style="padding: 5px;">
        <h6 style="margin: 0 0 5px 0; color: #e77a3a; font-weight: bold;">PrimeLand Hotel</h6>
