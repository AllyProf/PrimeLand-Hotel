          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr class="payment-row"
                ...
                <td>
                  <strong>TZS {{ number_format($payment->amount_paid ?? $payment->total_price, 0) }}</strong>
                </td>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <table class="table table-sm table-bordered">
                ...
                <tr><td><strong>Amount Paid:</strong></td><td><strong>TZS ${(parseFloat(booking.amount_paid || booking.total_price || 0)).toLocaleString()}</strong></td></tr>
                ...
                <tr><td><strong>Remaining Amount:</strong></td><td><strong style="color: #dc3545;">TZS ${(parseFloat((booking.total_price || 0) - (booking.amount_paid || 0))).toLocaleString()}</strong></td></tr>
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-6">
              ...
              <table class="table table-sm table-bordered">
                ...
                <tr><td><strong>Price per Night (Rate):</strong></td><td>TZS ${(parseFloat(room.price_per_night || 0)).toLocaleString()}</td></tr>
                <tr><td><strong>Total Booking Price:</strong></td><td><strong>TZS ${(parseFloat(booking.total_price || 0)).toLocaleString()}</strong></td></tr>
              </table>
            </div>
          </div>
        </div>
