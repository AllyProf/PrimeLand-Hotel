    ...
    <div class="tile">
      <div class="tile-body">
        ...
        <div class="text-center mb-4" style="border-bottom: 3px solid #e07632; padding-bottom: 20px;">
          <h2 style="color: #e07632; margin-bottom: 5px;">PrimeLand Hotel</h2>
              ...
              <div style="background-color: #f8f9fa; padding: 20px; border: 2px solid #e07632;">
                <table class="table table-borderless mb-0">
                  <tr>
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayRoomPriceTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayRoomPriceUsd, 2) }}</small>
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayExtensionTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayExtensionUsd, 2) }}</small>
                      <br><small class="text-success"><i class="fa fa-check-circle"></i> Paid by Company</small>
                    </td>
                  </tr>
                  @endif
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayTotalServiceTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayTotalServiceTsh / $exchangeRate, 2) }}</small>
                      <br><small class="text-success"><i class="fa fa-check-circle"></i> Paid by Company</small>
                    </td>
                  </tr>
                  @endif
                  <tr style="border-top: 2px solid #e07632;">
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayTotalBillTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayTotalBillUsd, 2) }}</small>
              ...
              <div style="background-color: #f8f9fa; padding: 20px; border: 2px solid #e07632;">
                <table class="table table-borderless mb-0">
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayGuestServiceTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayGuestServiceTsh / $exchangeRate, 2) }}</small>
                  ...
                  <tr style="border-top: 2px solid #e07632;">
                    ...
                    <td class="text-right">
                      <strong>{{ number_format($displayTotalBillTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayTotalBillTsh / $exchangeRate, 2) }}</small>
                    </td>
                  </tr>
                  <tr style="border-top: 1px solid #ddd;">
                    <td><strong>Company Portion:</strong></td>
                    <td class="text-right">
                      <strong style="color: #28a745;">{{ number_format($displayCompanyBillTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayCompanyBillTsh / $exchangeRate, 2) }}</small>
                      <br><small class="text-success"><i class="fa fa-building"></i> Paid by {{ $booking->company->name ?? 'Company' }}</small>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-right">
                      <strong style="color: {{ $displayGuestServiceTsh > 0 ? '#e07632' : '#28a745' }};">{{ number_format($displayGuestServiceTsh, 2) }} TZS</strong><br>
                      <small class="text-muted">≈ ${{ number_format($displayGuestServiceTsh / $exchangeRate, 2) }}</small>
                      @if($displayGuestServiceTsh > 0)
        ...
        <div class="mb-4">
          ...
          <div class="table-responsive">
            ...
            <p class="text-muted" style="font-size: 12px; margin-top: 10px;">
              <i class="fa fa-info-circle"></i> Exchange Rate (Locked at Booking): 1 USD = {{ number_format($exchangeRate, 2) }} TZS
            </p>
          </div>
        </div>
        @endif
            ...
            <div style="background-color: #f8f9fa; padding: 20px; border: 2px solid #e07632;">
              <table class="table table-borderless mb-0">
                ...
                <tr style="border-top: 2px solid #e07632;">
                  ...
                  <td class="text-right">
                    <strong>{{ number_format($totalBillTsh ?? 0, 2) }} TZS</strong><br>
                    <small class="text-muted">≈ ${{ number_format(($totalBillTsh ?? 0) / $exchangeRate, 2) }}</small>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <strong style="color: #28a745;">{{ number_format($amountPaidTsh, 2) }} TZS</strong><br>
                    <small class="text-muted">≈ ${{ number_format($amountPaidUsd, 2) }}</small>
                  </td>
                </tr>
                @endif
                ...
                <tr style="border-top: 2px solid #e07632; font-size: 18px;">
                  ...
                  <td class="text-right">
                    <strong style="color: #e07632; font-size: 24px;">{{ number_format($outstandingBalanceTsh, 2) }} TZS</strong><br>
              ...
              <td>
                 @if($isCorporateSelfPaid)
                  ...
                  @elseif($selfPaidAmountPaid > 50)
                    ...
                    <br><small class="text-muted">{{ number_format($amountPaidUsd, 2) }} USD paid of {{ number_format($selfPaidTotal / $exchangeRate, 2) }} USD total</small>
                  @else
                    <span class="badge badge-danger" style="font-size: 14px;"><i class="fa fa-clock-o"></i> Unpaid / Pending</span>
                    <br><small class="text-muted">Total Outstanding: {{ number_format($selfPaidTotal / $exchangeRate, 2) }} USD</small>
                  @endif
                @elseif($isStaffViewingCorporate)
                  @if($booking->company)
                ...
                @else
                  ...
                  @else
                    ...
                    <br><small class="text-muted">Total Due: {{ number_format($totalExpectedTsh, 2) }} TZS (≈ ${{ number_format($totalExpectedTsh / $exchangeRate, 2) }})</small>
                  @endif
                @endif
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <small class="text-muted">
                  <i class="fa fa-info-circle"></i> Can be paid at checkout or via PayPal
                </small>
              </td>
            </tr>
            @endif
                ...
                @if($isCorporateSelfPaid)
                  @if(($totalServiceChargesTsh ?? 0) > 0)
                    @if(($outstandingBalanceTsh ?? 0) > 0)
                      ...
                      <br>
                      <small class="text-muted">
                        {{ number_format($outstandingBalanceTsh ?? 0, 2) }} TZS remaining (≈ ${{ number_format(($outstandingBalanceTsh ?? 0) / $exchangeRate, 2) }})
                      </small>
                    @else
                      <span class="badge badge-success">Paid</span>
                      <br>
                      <small class="text-muted">
                        {{ number_format($totalServiceChargesTsh ?? 0, 2) }} TZS (≈ ${{ number_format(($totalServiceChargesTsh ?? 0) / $exchangeRate, 2) }})
                      </small>
                    @endif
                  @else
        ...
        <div class="text-center mt-4" style="border-top: 2px solid #e07632; padding-top: 20px;">
          <p style="color: #666; margin: 0;">
            <strong>Thank you for staying with PrimeLand Hotel!</strong><br>
