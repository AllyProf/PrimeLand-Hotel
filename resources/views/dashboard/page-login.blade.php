...
<html>
  <head>
    ...
    <title>Login - PrimeLand Hotel</title>
  </head>
  <body>
    <!-- Mobile Header with Back Button -->
    <div class="mobile-login-header">
      <a href="{{ url('/') }}" class="mobile-back-button" title="Return to Home">
    ...
    <section class="login-content">
      <!-- Return to Home Arrow (Desktop) -->
      <a href="{{ url('/') }}" class="return-home-arrow" title="Return to Home">
        <i class="fa fa-arrow-left"></i>
      </a>
