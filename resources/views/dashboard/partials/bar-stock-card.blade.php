        ...
        <div class="card-body p-3">
            <div class="row">
                ...
                <div class="col-4 pr-2">
                    ...
                    <img src="{{ Storage::url($item['product_image']) }}" alt="{{ $item['product_name'] }}" class="rounded w-100" style="height: 85px; object-fit: cover; border: 3px solid #f0f0f0;">
                    @else
                    <div class="rounded bg-light d-flex align-items-center justify-content-center w-100" style="height: 85px; border: 3px solid #f0f0f0;">
                        <i class="fa fa-wine-glass fa-3x text-muted"></i>
                    </div>
                    @endif
                    <div class="text-center mt-1">
                        <span class="badge badge-secondary" style="font-size: 10px;">{{ $item['variant_name'] }}</span>
                    </div>
                </div>
                ...
                <div class="col-8 pl-2">
                    ...
                    <div class="mb-2 px-2 py-1 bg-white border rounded" style="font-size: 10.5px; color: #444; border-style: dashed !important; border-color: #dee2e6 !important;">
                    ...
                    <div class="mb-1 p-2 bg-light rounded shadow-sm border">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-1" style="font-size: 11px;">
                            ...
                            <strong class="text-success">{{ number_format($item['current_profit'], 0) }} <small>TSH</small></strong>
                        </div>
                    </div>
                </div>
            </div>
