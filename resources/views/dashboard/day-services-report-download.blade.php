...
<head>
    ...
    <title>Day Services Report - {{ $dateRange['label'] }} - PrimeLand Hotel</title>
    ...
    <div class="receipt-container">
        ...
        <div class="header">
            <div class="logo-container">
                <img src="{{ asset('royal-master/image/logo/Logo.png') }}" alt="PrimeLand Hotel Logo" onerror="this.style.display='none';">
            </div>
            ...
            <div style="margin-top: 10px; margin-bottom: 10px; line-height: 1.8;">
                ...
                <p style="margin: 5px 0; font-size: 13px; color: #555;">
                    <strong>Email:</strong> info@primelandhotel.co.tz / infoprimelandhotel@gmail.com
                </p>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>PrimeLand Hotel</strong></p>
