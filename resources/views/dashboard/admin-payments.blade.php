...
<div class="row mb-3">
  <div class="col-md-6">
    <div class="alert alert-warning" style="margin-bottom: 0;">
      ...
      (${{ number_format($stats['pending_amount'] ?? 0, 2) }} / ≈ {{ number_format(($stats['pending_amount'] ?? 0) * ($exchangeRate ?? 2500), 0) }} TZS)
    </div>
  </div>
  <div class="col-md-6">
    <div class="alert alert-info" style="margin-bottom: 0;">
      ...
      (${{ number_format($stats['partial_amount'] ?? 0, 2) }} / ≈ {{ number_format(($stats['partial_amount'] ?? 0) * ($exchangeRate ?? 2500), 0) }} TZS outstanding)
    </div>
  </div>
</div>
@endif
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <table class="table table-sm table-bordered">
                ...
                <tr><td><strong>Amount Paid:</strong></td><td><strong style="color: #28a745;">$${parseFloat(booking.amount_paid || 0).toFixed(2)} USD</strong></td></tr>
                <tr><td><strong>Amount Paid (TZS):</strong></td><td><strong>${(parseFloat(booking.amount_paid || 0) * exchangeRate).toLocaleString()} TZS</strong></td></tr>
                ...
                <tr><td><strong>Remaining (TZS):</strong></td><td><strong>${(parseFloat((booking.total_price || 0) - (booking.amount_paid || 0)) * exchangeRate).toLocaleString()} TZS</strong></td></tr>
                ` : ''}
