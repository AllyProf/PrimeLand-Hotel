            ...
            if (successHits > 0) {
                await Swal.fire({
                    ...
                    html: `
                        ...
                        <div class="mt-3 p-3 rounded" style="background: #f8f9fa; border: 1px dashed #e77a31;">
                            <small class="text-muted d-block mb-1">Need to confirm or modify?</small>
                            <strong>Call Reception: 0677155156 or Ext: 601</strong>
                        </div>
                    `,
                    icon: "success",
                    confirmButtonColor: '#e77a31'
