    ...
    <div class="tile">
      ...
      <div class="tile-body">
        ...
        <div class="row">
          ...
          <!-- Weather Details -->
          <div class="col-md-6">
            <h5 style="color: #e77a3a; margin-bottom: 15px;">Weather Details</h5>
            <table class="table table-sm table-borderless">
              <tr>
                <td style="width: 40px;"><i class="fa fa-map-marker" style="color: #e77a3a;"></i></td>
                <td><strong>Location:</strong></td>
                <td>{{ $weather['city'] }}, {{ $weather['country'] }}</td>
              </tr>
              <tr>
                <td><i class="fa fa-tint" style="color: #e77a3a;"></i></td>
                <td><strong>Humidity:</strong></td>
                <td>{{ $weather['humidity'] }}%</td>
              </tr>
              <tr>
                <td><i class="fa fa-compress" style="color: #e77a3a;"></i></td>
                <td><strong>Pressure:</strong></td>
                <td>{{ $weather['pressure'] }} hPa</td>
              </tr>
              <tr>
                <td><i class="fa fa-leaf" style="color: #e77a3a;"></i></td>
                <td><strong>Wind:</strong></td>
                <td>{{ $weather['wind_speed'] }} km/h {{ $weather['wind_direction'] }}</td>
              </tr>
              @if($weather['visibility'])
              <tr>
                <td><i class="fa fa-eye" style="color: #e77a3a;"></i></td>
              ...
              @endif
              <tr>
                <td><i class="fa fa-clock-o" style="color: #e77a3a;"></i></td>
        ...
        <h5 style="color: #e77a3a; margin-bottom: 15px;">5-Day Forecast</h5>
        <div class="row">
          ...
          <div class="col-md-2 col-sm-4 col-6 mb-3">
            <div class="text-center" style="padding: 15px; background: #f8f9fa; border-radius: 8px;">
              <p style="margin: 0; font-weight: bold; color: #e77a3a;">{{ date('D', strtotime($day['date'])) }}</p>
      ...
      <div class="tile-body">
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <div class="card" style="border-left: 4px solid #e77a3a;">
              <div class="card-body">
                <h5 class="card-title">
                  <i class="fa fa-{{ $attraction['type'] === 'Natural' ? 'tree' : 'building' }}" style="color: #e77a3a;"></i>
                  {{ $attraction['name'] }}
                </h5>
      ...
      <div class="tile-body">
        <div class="list-group">
          ...
          <div class="list-group-item">
            <h6 class="mb-1">
              <i class="fa fa-{{ $transport['type'] === 'Taxi' ? 'taxi' : ($transport['type'] === 'Airport Shuttle' ? 'plane' : ($transport['type'] === 'Car Rental' ? 'car' : 'bus')) }}" style="color: #e77a3a;"></i>
              {{ $transport['type'] }}
            </h6>
