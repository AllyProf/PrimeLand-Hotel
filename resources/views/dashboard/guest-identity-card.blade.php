...
<head>
    ...
    <title>PrimeLand Hotel - Guest Identity Card</title>
...
<body>
    <div class="print-container">
        <div class="print-header">
            <div class="hotel-name">PRIMELAND HOTEL</div>
            ...
            <div class="card-container">
                <div class="card-left-section">
                    <div class="card-header">
                        <img src="{{ asset('royal-master/image/logo/Logo.png') }}" alt="PrimeLand Hotel Logo" class="hotel-logo-img" onerror="this.style.display='none';">
                    </div>
                    <div class="hotel-text-brand">
                        <div class="hotel-logo">PRIMELAND</div>
