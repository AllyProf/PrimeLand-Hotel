...
<div class="row">
  ...
  <div class="col-md-6 mb-4">
    <div class="tile" style="box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: none; border-radius: 8px; overflow: hidden;">
      <div class="tile-title-w-btn" style="background: linear-gradient(135deg, #e77a3a 0%, #d66a2a 100%); color: white; padding: 15px 20px; margin: 0;">
        <h3 class="tile-title" style="color: white; margin: 0; font-weight: 600;">
          <i class="fa fa-bed"></i> {{ $room->room_type ?? 'N/A' }}
        </h3>
        <div class="btn-group">
          <span class="badge badge-light" style="font-size: 14px; padding: 6px 12px; color: #e77a3a; font-weight: 600;">Room {{ $room->room_number ?? 'N/A' }}</span>
        </div>
      </div>
      <div class="tile-body" style="padding: 20px;">
        ...
        <div class="mb-4">
          <h5 style="color: #e77a3a; font-weight: 600; margin-bottom: 15px; padding-bottom: 8px; border-bottom: 2px solid #e77a3a;">
          ...
          <div class="row">
            <div class="col-md-6">
              <table class="table table-sm table-borderless mb-0">
                <tr>
                  <td style="width: 140px; vertical-align: middle;"><strong><i class="fa fa-home" style="color: #e77a3a;"></i> Room Number:</strong></td>
                  <td><span class="badge badge-primary" style="font-size: 13px; padding: 6px 12px;">{{ $room->room_number ?? 'N/A' }}</span></td>
                </tr>
                @if($room->capacity)
                <tr>
                  <td style="vertical-align: middle;"><strong><i class="fa fa-users" style="color: #e77a3a;"></i> Capacity:</strong></td>
                  <td>{{ $room->capacity }} Guest(s)</td>
                </tr>
                @endif
                @if($room->bed_type)
                <tr>
                  <td style="vertical-align: middle;"><strong><i class="fa fa-bed" style="color: #e77a3a;"></i> Bed Type:</strong></td>
                  <td>{{ $room->bed_type }}</td>
                </tr>
                @endif
              </table>
            ...
            <div class="col-md-6">
              <table class="table table-sm table-borderless mb-0">
                ...
                <tr>
                  <td style="width: 140px; vertical-align: middle;"><strong><i class="fa fa-building" style="color: #e77a3a;"></i> Floor:</strong></td>
                  <td>{{ $room->floor_location }}</td>
                </tr>
                @endif
                @if($room->bathroom_type)
                <tr>
                  <td style="vertical-align: middle;"><strong><i class="fa fa-shower" style="color: #e77a3a;"></i> Bathroom:</strong></td>
                  <td>{{ $room->bathroom_type }}</td>
                </tr>
                @endif
                @if($room->price_per_night)
                <tr>
                  <td style="vertical-align: middle;"><strong><i class="fa fa-dollar" style="color: #e77a3a;"></i> Price/Night:</strong></td>
...
function showRoomDetailsModal(roomId) {
  ...
  contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-home" style="color: #e77a3a;"></i> Room Number:</span><span class="info-value"><strong>' + room.number + '</strong></span></div>';
  if (room.capacity) {
    contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-users" style="color: #e77a3a;"></i> Capacity:</span><span class="info-value">' + room.capacity + ' Guest(s)</span></div>';
  }
  if (room.bedType) {
    contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-bed" style="color: #e77a3a;"></i> Bed Type:</span><span class="info-value">' + room.bedType + '</span></div>';
  }
  contentHtml += '</div>';
  contentHtml += '<div class="col-md-6">';
  if (room.floor) {
    contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-building" style="color: #e77a3a;"></i> Floor:</span><span class="info-value">' + room.floor + '</span></div>';
  }
  if (room.bathroom) {
    contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-shower" style="color: #e77a3a;"></i> Bathroom:</span><span class="info-value">' + room.bathroom + '</span></div>';
  }
  if (room.price) {
    const priceTzs = (parseFloat(room.price) * exchangeRate).toLocaleString('en-US');
    contentHtml += '<div class="info-row"><span class="info-label"><i class="fa fa-dollar" style="color: #e77a3a;"></i> Price/Night:</span><span class="info-value"><strong>$' + parseFloat(room.price).toFixed(2) + '</strong> ≈ <strong>' + priceTzs + ' TZS</strong></span></div>';
  }
  contentHtml += '</div>';
  contentHtml += '</div>';
  contentHtml += '</div>';
