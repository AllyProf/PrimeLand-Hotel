...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-body">
        <!-- Hotel Header -->
        <div class="text-center mb-4" style="border-bottom: 3px solid #e77a3a; padding-bottom: 20px;">
          <h2 style="color: #e77a3a; margin-bottom: 5px;">PrimeLand Hotel</h2>
        ...
        <div class="row mb-4">
          <div class="col-md-6">
            <h5 style="color: #e77a3a; border-bottom: 2px solid #e77a3a; padding-bottom: 10px; margin-bottom: 15px;">Company Information</h5>
          ...
          <div class="col-md-6 text-md-right">
            <h5 style="color: #e77a3a; border-bottom: 2px solid #e77a3a; padding-bottom: 10px; margin-bottom: 15px;">Invoice Details</h5>
        ...
        <!-- Breakdown Table -->
        <div class="mb-4">
          <h5 style="color: #e77a3a; border-bottom: 2px solid #e77a3a; padding-bottom: 10px; margin-bottom: 15px;">Guest Charges Summary</h5>
        ...
        <div class="row mt-5">
          <div class="col-md-6 mb-4">
            <div style="padding: 20px; border: 1px dashed #ddd; border-radius: 10px; height: 100%;">
              ...
              <p style="font-size: 13px; color: #777;">
                ...
                3. This is an official document generated by PrimeLand Hotel Property Management System.
              </p>
          ...
          <div class="col-md-6 mb-4">
            <div style="background: #f8f9fa; padding: 25px; border-radius: 10px; border: 2px solid #e77a3a;">
