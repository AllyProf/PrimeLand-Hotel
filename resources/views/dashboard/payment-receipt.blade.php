...
<body>
    ...
    <div class="receipt-container">
        ...
        <img src="{{ asset('royal-master/image/primeland_stamp.png') }}" alt="Hotel Stamp" class="hotel-stamp">
        ...
        <div class="header">
            <div class="hotel-info">
                ...
                <p><i class="fa fa-envelope"></i> info@primelandhotel.co.tz</p>
            </div>
            ...
            <tbody>
                ...
                @else
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">${{ number_format($b->room->price_per_night, 2) }}</td>
        ...
        <div class="summary-wrapper">
            <div class="summary-box">
                ...
                <div class="summary-row" style="font-size: 11px; margin-top: 5px;">
                    <b style="color: grey;">TZS Equivalent:</b>
                    <span style="color: grey;">{{ number_format($grandTotalUSD * $currentExchangeRate, 0) }} TZS</span>
                </div>
                @if($booking->locked_exchange_rate)
                <div class="summary-row" style="font-size: 10px; margin-top: 3px;">
                    <b style="color: #94a3b8;">Exchange Rate:</b>
                    <span style="color: #94a3b8;">1 USD = {{ number_format($booking->locked_exchange_rate, 2) }} TZS</span>
                </div>
                @endif
                ...
                @else
                    ...
                    <div class="summary-row" style="color: var(--danger); font-weight: 600; font-size: 11px;">
                        <b style="color: grey;">TZS Balance:</b>
        ...
        <div class="footer-grid">
            ...
            <div class="policies-section">
                <div class="policy-column">
                    <h4 style="font-size: 11px; font-weight: 700; text-transform: uppercase; color: var(--primary); margin-bottom: 8px;">
                        <i class="fa fa-file-text"></i> Booking Policy
                    </h4>
            ...
            <div class="signature-area">
                ...
                <p style="font-size: 10px; color: grey; margin-top: 5px;">PrimeLand Hotel Management</p>
        ...
        <div style="text-align: center; margin-top: 40px; border-top: 1px dashed #eee; padding-top: 20px;">
            <p style="font-size: 13px; font-weight: 600; color: var(--primary);">Thank you for choosing PrimeLand Hotel!</p>
