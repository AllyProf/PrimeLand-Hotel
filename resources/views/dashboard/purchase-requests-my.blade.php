...
<div class="row mb-3">
  <div class="col-md-12">
    ...
    <ul class="nav nav-tabs" role="tablist" style="background: #f8f9fa; padding: 8px; border-radius: 8px 8px 0 0; margin-bottom: 0;">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="receive-tab" data-toggle="tab" href="#receive" role="tab" aria-controls="receive" aria-selected="true" style="color: #e77a3a; font-weight: 600;">
