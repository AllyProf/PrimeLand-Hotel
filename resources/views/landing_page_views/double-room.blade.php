...
@section('title', 'Double Room in Moshi | Hotel Accommodation in Moshi, Tanzania')

@section('content')
    <!-- Breadcrumb Section Start -->
    <div class="gt-breadcrumb-wrapper bg-cover"
        style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('assets/img/new_images/room_(2).jpg') }}');">
        <div class="container">
            <div class="gt-page-heading">
                <div class="gt-breadcrumb-sub-title">
                    <h1 class="text-white wow fadeInUp" data-wow-delay=".3s">Double Room in Moshi</h1>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="gt-room-items">
                            <div class="room-image">
                                <img src="{{ asset('assets/img/new_images/room_(2).jpg') }}" alt="Double room in Moshi - Primeland Hotel" style="max-width: 100%; height: auto; border-radius: 8px;">
                            </div>
                            <div class="gt-room-content">
                                <h5>$85 / NIGHT</h5>
                                <h2>Double Room</h2>
                                <p>Experience local hospitality in our elegant Double Room. Perfect for couples or business travelers, featuring a Queen size bed and all our standard premium amenities.</p>
                                <div class="gt-list">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <ul class="chack-list">
