...
@section('title', 'Double Room | Primeland Hotel - Moshi, Kilimanjaro')
                    ...
                    <div class="col-lg-8">
                        <div class="gt-room-items">
                            <div class="room-image">
                                <img src="{{ asset('assets/img/new_images/room_(2).jpg') }}" alt="Double Room" style="max-width: 100%; height: auto; border-radius: 8px;">
                            </div>
