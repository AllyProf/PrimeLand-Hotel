...
@section('title', 'Twin Room in Moshi Hotel | Accommodation in Moshi, Tanzania')
        ...
        <div class="container">
            <div class="gt-page-heading">
                <div class="gt-breadcrumb-sub-title">
                    <h1 class="text-white wow fadeInUp" data-wow-delay=".3s">Twin Room in Moshi</h1>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="gt-room-items">
                            <div class="room-image">
                                <img src="{{ asset('assets/img/new_images/room_(6).jpg') }}" alt="Twin room in Moshi hotel - Primeland Hotel" style="max-width: 100%; height: auto; border-radius: 8px;">
                            </div>
