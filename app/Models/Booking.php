...
class Booking extends Model
{
    ...
    protected $casts = [
        ...
        'original_exchange_rate' => 'decimal:4',
        'exchange_rate_overridden_at' => 'datetime',
        'cancellation_fee' => 'decimal:2',
        'cancellation_fee_percentage' => 'decimal:2',
        'payment_deadline' => 'datetime',
        'identity_captured_at' => 'datetime',
        'checkin_token_expires_at' => 'datetime',
        'checkout_token_expires_at' => 'datetime',
        'checked_out_at_tablet' => 'datetime',
        'mobile_checkin_submitted_at' => 'datetime',
    ];
